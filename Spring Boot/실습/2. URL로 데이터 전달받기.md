    ...
    2. 웹 브라우저에서 아래 두 주소를 각각 입력해본다.
        - `http://localhost:8080/hello`
            ...
            - **결과**: `Hello, World!`
                ...
                <img width="383" height="105" alt="Image" src="https://github.com/user-attachments/assets/f33d16b3-f015-4c09-afa4-126819c24876" />
                
        - `http://localhost:8080/hello?name=Steve`
            - `name` 파라미터 값으로 “Steve”가 전달된다.
            - **결과**: `Hello, Steve!`
                
                <img width="471" height="110" alt="Image" src="https://github.com/user-attachments/assets/fbabe552-93d2-49d7-8d5a-52c47e3c69b1" />
    ...
    2. 웹 브라우저에서 아래 주소를 입력한다.
        - `http://localhost:8080/hello/Steve`
            ...
            - **결과**: `Hello from path, Steve!`
                ...
                <img width="421" height="101" alt="Image" src="https://github.com/user-attachments/assets/4d922d08-fca6-4596-843b-4839289be084" />
